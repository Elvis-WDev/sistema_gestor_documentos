...
return [
    ...
    'attributes' => [
        ...
        'fecha_abonado'               => 'Fecha del Abono',
        'Archivo'                     => 'Archivo',
        'id_modulo'                   => 'ID de carpeta',
        'id_usuario'                  => 'ID del Usuario',
        'Nombre'                      => 'Nombre',
        'id_archivo'                  => 'ID del Archivo',
        'id'                          => 'ID',
        'nombre'                      => 'Nombre',
        'archivos_permitidos.*'       => 'Archivos Permitidos',
        'cantidad_permitidos'         => 'Cantidad Permitida',
        'tamano_maximo_permitido'     => 'Tamaño Máximo Permitido',
        'RetencionIva'                => 'Retención IVA',
        'RetencionFuente'             => 'Retención Fuente',
        'RazonSocial'                 => 'Razón Social',
        'Total'                       => 'Total',
        'Archivos.*'                  => 'Archivos',
        'old_archivos'                => 'Archivos Anteriores',
        ...
        'id_pago'                     => 'ID del Pago',
        'NombreModulo'                => 'Nombre de carpeta',
        'password'                    => 'Contraseña',
        'txt_fecha_reporte_inicio'    => 'Fecha inicio',
        'txt_fecha_reporte_final'     => 'Fecha final',
        'name'                        => 'Nombre del Rol',
