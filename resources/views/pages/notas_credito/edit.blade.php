...
@section('title')
    DigiDocs || Editar notas de crédito
@endsection
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Editar nota de crédito</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 ">
                                    ...
                                    <input class="form-control" name="FechaEmision" type="text" id="FechaEmision"
                                        value="{{ $NotaCredito->FechaEmision }}">
                                </div>
                                ...
                                <div class="form-group col-sm-6 ">
                                    ...
                                    <input class="form-control" name="Establecimiento" type="text" id="Establecimiento"
                                        value="{{ $NotaCredito->Establecimiento }}">
                                </div>
                                ...
                                <div class="form-group col-sm-6 ">
                                    ...
                                    <input class="form-control" name="PuntoEmision" type="text" id="PuntoEmision"
                                        value="{{ $NotaCredito->PuntoEmision }}">
                                </div>
