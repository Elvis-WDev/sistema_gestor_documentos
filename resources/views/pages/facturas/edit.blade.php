                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 ">
                                    ...
                                    <select class="form-control" id="Estado" name="Estado">
                                        <option value="1" {{ $Factura->Estado == 1 ?? 'selected' }}>Pagada</option>
                                        <option value="2" {{ $Factura->Estado == 2 ?? 'selected' }}>Anulada</option>
                                        <option value="3" {{ $Factura->Estado == 3 ?? 'selected' }}>Abonada</option>
                                    </select>
                                </div>
