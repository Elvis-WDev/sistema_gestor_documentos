...
class RetencionesDataTable extends DataTable
{
    /**
     ...
     */
    public function query(Retenciones $model): QueryBuilder
    {
    ...
    {
        return 'Retenciones_' . date('YmdHis');
    }
}
